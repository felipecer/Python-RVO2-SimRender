...
class RVOMiacPerp1(gym.Env):
    ...
    def __init__(self, config_file=None, render_mode="rgb", seed=None):
        ...
        # Set renderers if rendering is required
...
if __name__ == "__main__":
    env = RVOMiacPerp1('./simulator/worlds/miac/perp1/perp1_level_2.yaml', render_mode='rgb')
