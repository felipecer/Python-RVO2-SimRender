...
def run_baseline_orca_circle_level2(num_runs=10, render_mode=None, seed=42, tag='baseline_orca'):
    ...
    results_file = os.path.join(save_dir, f'circle_level2_baseline_orca_{unique_id}.csv')
...
if __name__ == "__main__":
    ...
    df = run_baseline_orca_circle_level2(num_runs=500, render_mode=None, seed=42, tag='baseline_orca_circle_2')