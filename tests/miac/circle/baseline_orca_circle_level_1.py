...
def run_baseline_orca_circle_level1(num_runs=10, render_mode=None, seed=42, tag='baseline_orca'):
    ...
    config_file = './simulator/worlds/miac/circle/circle_level_5.yaml'
    results = []
...
if __name__ == "__main__":
    ...
    df = run_baseline_orca_circle_level1(num_runs=1000, render_mode=None, seed=42, tag='baseline_orca_circle_1')