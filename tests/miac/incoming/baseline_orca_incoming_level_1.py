...
def run_baseline_orca_incoming_level1(num_runs=10, render_mode=None, seed=42, tag='baseline_orca'):
    """Run baseline ORCA algorithm on incoming_level_1 with action=[0,0]"""
    
    config_file = './simulator/worlds/miac/incoming/incoming_level_1.yaml'
    results = []
    ...
    results_file = os.path.join(save_dir, f'incoming_level1_baseline_orca_{unique_id}.csv')
...
if __name__ == "__main__":
    ...
    df = run_baseline_orca_incoming_level1(num_runs=1000, render_mode=None, seed=42, tag='baseline_orca_incoming_1')