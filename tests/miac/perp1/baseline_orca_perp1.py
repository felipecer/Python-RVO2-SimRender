...
def run_baseline_orca_perp1_level0(num_runs=10, render_mode=None, seed=42, tag='baseline_orca'):
    """Run baseline ORCA algorithm on perp1_level_0 with action=[0,0]"""
    ...
    results_file = os.path.join(save_dir, f'perp1_level0_baseline_orca_{unique_id}.csv')
...
if __name__ == "__main__":
    ...
    df = run_baseline_orca_perp1_level0(num_runs=1000, render_mode=None, seed=42, tag='baseline_orca_perp1_0')